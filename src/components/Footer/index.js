  ...
  return (
    <div>
      <div class="social-media">
        <div>
          <ul class="social-list">
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/ikechuku/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Linkedin"
              >
            ...
            <li>
              <a
                href="https://codepen.io/ikechuku"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Codepen"
              >
      ...
      <div class="email-container">
        <div class="email-me">
          <a href="mailto:sir_ik@yahoo.com">sir_ik@yahoo.com</a>
        </div>
      </div>
      <footer id="footer">
        <div class="footer-links">
          <ul class="social-list-footer">
            ...
            <li>
              <a
                href="https://www.instagram.com/ikechuku"
                target="_blank"
                rel="noopener noreferrer"
